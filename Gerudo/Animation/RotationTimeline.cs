...
namespace Gerudo
{
    public class RotationTimeline : Timeline<Quaternion>
    {
        public override Quaternion Sample(float currentTime)
        {
            ...
            Quaternion rot = Quaternion.Slerp(currentFrame.value, nextFrame.value, delta);
